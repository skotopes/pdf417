...
def test_compact():
    ...
    assert do_compact("ABC123") == [1, 88, 32, 119]
...
VARIANTS = (
    ...
    (
        ...
        [817, 131, 344, 841, 63, 125, 187, 249, 1, 87, 674, 521, 119],
    ),
    (
        "12345678901234 109876543210123 123 123 123",
        [902, 171, 209, 269, 12, 434,
         900, 809,
         902, 1, 791, 564, 354, 522, 323,
         900, 808, 32, 116, 32, 116, 32, 119]
    ),
    (
        "\x0B3333\x0B3333",
